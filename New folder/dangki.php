...
<div id="form">
<p>ĐĂNG KÍ</p>
<form action="module/xulydangki" method="post">
Tên đăng nhập:<br/>
<input type="text" autofocus="autofocus" name="taikhoan" placeholder="Tên đăng nhập" /><br />
Mật khẩu:<br />
<input type="password" name="matkhau1" /><br />
Nhập mật khẩu:<br />
<input type="password"/><br />
Họ tên:<br/>
<input type="text" autofocus="autofocus" name="ten" placeholder="Họ tên đầy đủ" /><br />
Giới tính: &nbsp  &nbsp 
<input type="radio" name="gt" value="1" checked/>Nam &nbsp <input type="radio" name="gt" value="0"/>Nữ<br />
Mail:<br/>
<input type="text" name="mail" placeholder="yourmail@mail.mail" /><br />
Địa chỉ:<br/>
<input type="text" name="diachi" placeholder="Địa chỉ" /><br />
Số điện thoại:<br/>
<input type="text" name="sdt" placeholder="Số điện thoại" /><br />
<div></div><br />
<input type="submit" name="sm" value="Đăng kí" />
</form>
